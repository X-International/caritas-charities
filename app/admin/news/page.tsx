    ...
    <div className="space-y-6 py-2">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-gray-600 text-sm">
            Manage website news articles, press releases, and announcements.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-8 sm:p-12 text-center space-y-4 max-w-2xl mx-auto">
        ...
        <p className="text-gray-600 text-sm leading-relaxed max-w-lg mx-auto">
          This section will be connected to the website content management system in a later phase, allowing approved staff to draft, publish, and edit news articles.
        </p>
        <div className="pt-2">
          <Link
            href="/admin"
