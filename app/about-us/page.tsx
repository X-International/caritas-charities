        ...
        <article className="site-container py-16 sm:py-20 max-w-3xl mx-auto space-y-12 sm:space-y-16">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed text-base sm:text-lg">
              <p>
                The Charities Office operates under Caritas Kampala and serves people and communities facing poverty, vulnerability, displacement, disability, illness, and other forms of hardship across the Kampala Archdiocese.
              </p>
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed text-base sm:text-lg">
              <p>
                Caritas Kampala is the socio-pastoral ministry of the Catholic Church in the Kampala Archdiocese. Through the Charities Office, this mission is expressed in practical service to people in need, regardless of religion, sex, nationality, or background.
              </p>
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed text-base sm:text-lg">
              <p>
                The Charities Office is part of Caritas Kampala and does not operate as a separate organisation. Its work forms part of the wider social and pastoral mission of the Kampala Archdiocese.
              </p>
              <p>
