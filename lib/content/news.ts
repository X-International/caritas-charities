...
export const newsArticles: NewsArticle[] = [
  ...
  },
  {
    ...
    body: [
      "The Charities Office under Caritas Kampala has launched its dedicated website, creating a central place for people to learn about the office’s work across Kampala Archdiocese.",
      ...
      "The website is part of Caritas Kampala’s wider digital presence. It gives the Charities Office a dedicated space while maintaining a clear connection to Caritas Kampala and the wider mission of the Church across Kampala Archdiocese.",
