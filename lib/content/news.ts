...
export const newsArticles: NewsArticle[] = [
  {
    ...
    body: [
      ...
      "As Matthew 25:35 says, \"For I was hungry and you gave me food.\" This is the same passage that guides the wider mission of the Charity Office, and it is why responding to hunger, wherever it is found, remains central to this work.",
    ],
    helpSection: {
      title: "How to Help",
      content: [
        "Food, essential relief items, and other approved support materials can be delivered to the Charity Office.",
  ...
  },
  {
    ...
    body: [
      "The Charity Office under Caritas Kampala has launched its dedicated website, creating a central place for people to learn about the office’s work across Kampala Archdiocese.",
      ...
      "Visitors can also learn more about the people behind the Charity Office, explore photographs from programmes and community activities, and find practical information about donating or contacting the team.",
      "The website is part of Caritas Kampala’s wider digital presence. It gives the Charity Office a dedicated space while maintaining a clear connection to Caritas Kampala and the wider mission of the Church across Kampala Archdiocese.",
    ...
    exploreSection: {
      ...
      body: "Learn more about the work of the Charity Office, explore our programmes, or find a practical way to get involved.",
      links: [
  ...
  },
  {
    ...
    body: [
      "On 14 November 2025, the Charity Office held its first Breakfast Meeting at Cardinal Nsubuga Leadership Training Centre in Nsambya to commemorate the World Day of the Poor.",
      ...
      "The meeting strengthened connections between the Charity Office, CHACONET members and potential partners while encouraging practical solidarity, dignity and shared responsibility in responding to the needs of vulnerable communities.",
    ],
  },
];
