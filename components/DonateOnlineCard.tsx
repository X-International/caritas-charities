...
export default function DonateOnlineCard() {
  return (
    <section className="pt-5 sm:pt-7 pb-2 sm:pb-4">
      <div className="bg-[#ebe3d7] rounded-3xl p-6 sm:p-8 md:p-10 flex flex-col md:flex-row md:items-center gap-5 sm:gap-6 md:gap-8 text-center md:text-left shadow-sm shadow-gray-200/60">
