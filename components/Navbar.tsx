            ...
            >
              ...
              <div className="bg-gray-100/80 border-t border-gray-200 p-5 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  ...
                  >
                    <div className="w-8 h-8 rounded-lg bg-gray-100 text-gray-600 flex items-center justify-center shrink-0 group-hover:bg-gray-600 group-hover:text-white transition-colors border border-gray-200/80">
