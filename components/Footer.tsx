          ...
          <div className="w-full lg:w-auto space-y-4 shrink-0 text-center lg:text-right">
            ...
            <div className="flex items-center justify-center lg:justify-end gap-5">
              <div className="flex items-center gap-2" aria-label="Social channels">
                <a href="https://www.facebook.com/profile.php?id=61592649493991" target="_blank" rel="noopener noreferrer" aria-label="Facebook (opens in a new tab)" title="Facebook" className="group relative flex h-12 w-12 items-center justify-center rounded-full text-white/85 transition-all duration-300 hover:text-white hover:border-white/60 hover:bg-white/10 border border-white/30">
                ...
                <a href="https://www.instagram.com/charityofficecaritas" target="_blank" rel="noopener noreferrer" aria-label="Instagram (opens in a new tab)" title="Instagram" className="group relative flex h-12 w-12 items-center justify-center rounded-full text-white/85 transition-all duration-300 hover:text-white hover:border-white/60 hover:bg-white/10 border border-white/30">
                ...
                <a href="https://www.youtube.com/@charityofficecaritaskampala" target="_blank" rel="noopener noreferrer" aria-label="YouTube (opens in a new tab)" title="YouTube" className="group relative flex h-12 w-12 items-center justify-center rounded-full text-white/85 transition-all duration-300 hover:text-white hover:border-white/60 hover:bg-white/10 border border-white/30">
                ...
                <a href="https://x.com/charityoffmm" target="_blank" rel="noopener noreferrer" aria-label="X (formerly Twitter) (opens in a new tab)" title="X (formerly Twitter)" className="group relative flex h-12 w-12 items-center justify-center rounded-full text-white/85 transition-all duration-300 hover:text-white hover:border-white/60 hover:bg-white/10 border border-white/30">
