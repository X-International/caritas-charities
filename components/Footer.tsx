          ...
          <div className="w-full lg:w-auto space-y-4 shrink-0 text-center lg:text-right">
            ...
            <div className="flex items-center justify-center lg:justify-end gap-5">
              <div className="flex items-center gap-2" aria-label="Social channels">
                <a href="https://www.facebook.com/profile.php?id=61592649493991" target="_blank" rel="noopener noreferrer" aria-label="Facebook (opens in a new tab)" title="Facebook" className="group relative flex h-10 w-10 items-center justify-center rounded-full border border-white/25 bg-white/10 text-white/85 transition-[background-color,border-color,color] duration-200 hover:border-white/60 hover:bg-white/20 hover:text-white">
                ...
                <a href="https://www.instagram.com/charityofficecaritas" target="_blank" rel="noopener noreferrer" aria-label="Instagram (opens in a new tab)" title="Instagram" className="group relative flex h-10 w-10 items-center justify-center rounded-full border border-white/25 bg-white/10 text-white/85 transition-[background-color,border-color,color] duration-200 hover:border-white/60 hover:bg-white/20 hover:text-white">
                ...
                <a href="https://www.linkedin.com/in/charity-office-caritas-kampala-318713428" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn (opens in a new tab)" title="LinkedIn" className="group relative flex h-10 w-10 items-center justify-center rounded-full border border-white/25 bg-white/10 text-white/85 transition-[background-color,border-color,color] duration-200 hover:border-white/60 hover:bg-white/20 hover:text-white">
                  <svg className="h-4.5 w-4.5 fill-current" viewBox="0 0 24 24" aria-hidden="true"><path d="M20.4 2H3.6A1.6 1.6 0 0 0 2 3.6v16.8A1.6 1.6 0 0 0 3.6 22h16.8a1.6 1.6 0 0 0 1.6-1.6V3.6A1.6 1.6 0 0 0 20.4 2ZM7.7 18.8H4.6V9.4h3.1v9.4Zm-1.6-10.7a1.8 1.8 0 1 1 0-3.6 1.8 1.8 0 0 1 0 3.6Zm12.7 10.7h-3.1v-5.2c0-1.2 0-2.8-1.7-2.8-1.7 0-2 1.4-2 2.7v5.3h-3.1V9.4h3.1v1.3h.1c.4-.8 1.5-1.7 3.1-1.7 3.3 0 3.9 2.2 3.9 5v4.8Z" /></svg>
                </a>
                <a href="https://www.youtube.com/@charityofficecaritaskampala" target="_blank" rel="noopener noreferrer" aria-label="YouTube (opens in a new tab)" title="YouTube" className="group relative flex h-10 w-10 items-center justify-center rounded-full border border-white/25 bg-white/10 text-white/85 transition-[background-color,border-color,color] duration-200 hover:border-white/60 hover:bg-white/20 hover:text-white">
                ...
                <a href="https://x.com/charityoffmm" target="_blank" rel="noopener noreferrer" aria-label="X (formerly Twitter) (opens in a new tab)" title="X (formerly Twitter)" className="group relative flex h-10 w-10 items-center justify-center rounded-full border border-white/25 bg-white/10 text-white/85 transition-[background-color,border-color,color] duration-200 hover:border-white/60 hover:bg-white/20 hover:text-white">
